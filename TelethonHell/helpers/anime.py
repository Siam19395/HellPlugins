...
async def get_anilist(qdb, page):
    ...
    chnl = "[Siam Chowdhury](https://t.me/Chowdhury_Siam)"
    idm = data.get("id")
    ...
    for i in data["tags"]:
        tags.append(i["name"])
    tags_ = f"\n┣⪼ **🏷️ Tags :-** **__{', '.join(tags[:1])}__**" if tags != [] else ""
    in_ls = False
    in_ls_id = ""
    ...
    title_img = f"{idm}.jpg"
    logo = "https://telegra.ph/file/6d78bd72465845a955e20.jpg"
    descr = ""
