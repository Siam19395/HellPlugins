...
my_channel = Config.MY_CHANNEL or "Anime_Kun_Channel"
my_group = Config.MY_GROUP or "Anime_Kun_Channel"
if "@" in my_channel:
    my_channel = my_channel.replace("@", "")
if "@" in my_group:
    my_group = my_group.replace("@", "")

chnl_link = "https://t.me/Anime_Kun_Channel"
grp_link = "https://t.me/Anime_Kun_Channel"
hell_channel = f"[Anime Kun]({chnl_link})"
hell_grp = f"[Anime Kun]({grp_link})"
